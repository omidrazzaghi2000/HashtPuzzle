...
main: ./cpp/main.cpp  ./cpp/traverse.cpp 
	$(CXX) -I h -I /usr/local/include/gtest/ -I/usr/local/include -I/usr/include/freetype2 -I/usr/include/libpng16 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_THREAD_SAFE -D_REENTRANT -o 'main' './cpp/main.cpp' /usr/local/lib/libfltk.a -lXrender -lXext -lfontconfig -lpthread -ldl -lm -lX11 
clean:
